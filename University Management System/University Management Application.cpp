...
public:
    ...
    void displayfte()
    {
        ...
        cout<<r7;
        cout<<endl;
        cout<<"\n\t\t "<<r1<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r4<<"           DRONACHARYA COLLEGE OF ENGINEERING"<<endl;
        cout<<"\t\t "<<r6<<"  DCEGGN  "<<r6<<"          AFFLIATED TO MDU UNIVERSITY,  ROHTAK,\n";
        cout<<" \t\t "<<r2<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r3<<"         Khentawas,Farrukh Nagar Gurugram-122506\n";
        cout<<" \t\t                    Approved with Grade A by AICTE, New Delhi,\n";
        cout<<" \t\t                     Education Department, Govt. of Haryana.\n\n";
        for(int i=0;i<118;i++)
        cout<<r7;
        cout<<endl;
        home();
...
public:
    ...
    void result(string id)
    {
        ...
        for(int i=1;i<66;i++)
            cout<<r5;
            cout<<r4<<endl;
        cout<<"\t"<<r6<<" "<<r1<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r4<<"           DRONACHARYA COLLEGE OF ENGINEERING       "<<r6<<endl;
        cout<<"\t"<<r6<<" "<<r6<<"  DCEGGN  "<<r6<<"          AFFiLIATED TO MDU UNIVERSITY , ROHTAK     "<<r6<<endl;
        cout<<"\t"<<r6<<" "<<r2<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r3<<"         Khentawas,Farrukh Nagar Gurugram-122506    "<<r6<<endl;
        cout<<"\t"<<r6<<"                          Approved with Grade A by AICTE         "<<r6<<endl;
        cout<<"\t"<<r6<<"                      Education Department, Govt. of Haryana.    "<<r6<<endl;
        cout<<"\t"<<r6<<"                                                                 "<<r6<<endl;
